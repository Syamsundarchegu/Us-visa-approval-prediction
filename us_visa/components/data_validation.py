...
class DataValidation:
    def __init__(self,data_ingestion_artifact:DataIngestonAtrifact,data_validation_config:DataValidationConfig):
        try:
    ...
    def detect_dataset_drift(self,reference_df:DataFrame,current_df:DataFrame):
        try:
            ...
            logging.info(f"{n_drifted_features} /{n_features} dirft detected")
    ...
    def initiate_data_validation(self):
        try:
            ...
            data_validation_artifact = DataValidationAtrifact(validation_status=validation_status,message=validation_error_msg,drift_report_file_path=self.data_validation_config.drift_report_file_path)
