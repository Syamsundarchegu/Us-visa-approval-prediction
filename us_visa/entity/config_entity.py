...
class TrainingPipelineConfig:
    ...
    airtifact_dir:str = os.path.join(ARTIFACT_DIR,TIMESTAMP)
    timestamp:str = TIMESTAMP
    
train_pipline_config = TrainingPipelineConfig()
@dataclass
class DataIngestionConfig:
    data_ingestion_dir :str =  os.path.join(train_pipline_config.airtifact_dir,DATA_INGESTION_DIR_NAME)
